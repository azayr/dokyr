<script>
  ...
  $: commands = [
    ...
    { group: 'Navigate', icon: 'database', label: 'Databases', hint: '/databases', run: () => goto('/databases') },
    { group: 'Navigate', icon: 'globe', label: 'Domains', hint: '/domains', run: () => goto('/domains') },
    { group: 'Navigate', icon: 'mail', label: 'Mail', hint: '/mail', run: () => goto('/mail') },
    ...
    { group: 'Actions', icon: 'database', label: 'New database cluster', hint: '', run: () => goto('/databases?create=1') },
