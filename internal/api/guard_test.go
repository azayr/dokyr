...
var routePermissions = map[string]authz.Permission{
	...
	"PUT /api/settings/platform/domain": authz.PermPlatformWrite,
	...
	"POST /api/mail/api-keys":                                       authz.PermSecretWrite,
	"DELETE /api/mail/api-keys/{id}":                                authz.PermSecretWrite,
	"GET /api/projects":                                             authz.PermProjectRead,
	"POST /api/projects":                                            authz.PermProjectWrite,
	"GET /api/projects/{id}":                                        authz.PermProjectRead,
	"POST /api/projects/{id}/clone":                                 authz.PermProjectWrite,
	...
	"POST /api/projects/{id}/database-attachments":                  authz.PermProjectWrite,
	"DELETE /api/projects/{id}/database-attachments/{attachmentId}": authz.PermProjectWrite,
	...
	"GET /api/databases/{id}":                                   authz.PermProjectRead,
	"POST /api/databases/{id}/logical-databases":                authz.PermInfraWrite,
	"DELETE /api/databases/{id}/logical-databases/{databaseId}": authz.PermInfraWrite,
	"POST /api/databases/{id}/users":                            authz.PermInfraWrite,
	"GET /api/databases/{id}/users/{userId}/credentials":        authz.PermSecretRead,
	"DELETE /api/databases/{id}/users/{userId}":                 authz.PermInfraWrite,
	"POST /api/databases/{id}/grants":                           authz.PermInfraWrite,
	"DELETE /api/databases/{id}/grants/{databaseId}/{userId}":   authz.PermInfraWrite,
	"PUT /api/databases/{id}/exposure":                          authz.PermInfraWrite,
	"POST /api/databases/{id}/deploy":                           authz.PermInfraWrite,
	"POST /api/databases/{id}/stop":                             authz.PermInfraWrite,
	"POST /api/databases/{id}/restart":                          authz.PermInfraWrite,
	"GET /api/databases/{id}/logs":                              authz.PermProjectRead,
	"GET /api/databases/{id}/events":                            authz.PermProjectRead,
	"DELETE /api/databases/{id}":                                authz.PermInfraWrite,
	...
	"GET /api/projects/{id}/backups":                     authz.PermProjectRead,
	"POST /api/projects/{id}/backups":                    authz.PermProjectWrite,
	"PUT /api/projects/{id}/backups/schedule":            authz.PermProjectWrite,
	"POST /api/projects/{id}/backups/{backupId}/restore": authz.PermProjectWrite,
...
func TestSecretRoutesAreNotReadableByViewers(t *testing.T) {
	...
	secretRoutes := []string{
		...
		"GET /api/databases/{id}/users/{userId}/credentials",
...
func TestIngressRoutesAreOwnerOnly(t *testing.T) {
	...
	for _, pattern := range []string{
		...
		"PUT /api/settings/platform/domain",
	} {
		perm, ok := registered[pattern]
		if !ok {
			t.Fatalf("expected %q to be registered", pattern)
